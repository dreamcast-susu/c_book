...
# 68 "zpipe.c"
           ret != 
# 68 "zpipe.c" 3 4
           (-2)) ? 1 : 0), __extension__ ({ if (
# 68 "zpipe.c"
           ret != 
# 68 "zpipe.c" 3 4
           (-2)) ; else __assert_fail (
# 68 "zpipe.c"
           "ret != Z_STREAM_ERROR"
# 68 "zpipe.c" 3 4
           , "zpipe.c", 68, __extension__ __PRETTY_FUNCTION__); }))
# 68 "zpipe.c"
                                        ;
...
# 75 "zpipe.c"
       "strm.avail_in == 0"
# 75 "zpipe.c" 3 4
       , "zpipe.c", 75, __extension__ __PRETTY_FUNCTION__); }))
# 75 "zpipe.c"
                                 ;
...
# 79 "zpipe.c"
   "ret == Z_STREAM_END"
# 79 "zpipe.c" 3 4
   , "zpipe.c", 79, __extension__ __PRETTY_FUNCTION__); }))
# 79 "zpipe.c"
                              ;
...
# 126 "zpipe.c"
           "ret != Z_STREAM_ERROR"
# 126 "zpipe.c" 3 4
           , "zpipe.c", 126, __extension__ __PRETTY_FUNCTION__); }))
# 126 "zpipe.c"
                                        ;
            switch (ret) {
            case 
